...
pub(in crate::slash) fn valid_component_name(name: &str) -> bool {
...
pub(in crate::slash) fn valid_plugin_name(name: &str) -> bool {
    valid_component_name(name)
}
pub(in crate::slash) fn valid_marketplace_name(name: &str) -> bool {
    valid_component_name(name)
}
/// A plugin id is `plugin@marketplace`, each part a valid name.
pub(in crate::slash) fn valid_plugin_id(id: &str) -> bool {
    match id.split_once('@') {
...
pub(in crate::slash) fn git_arg_safe(value: &str) -> bool {
