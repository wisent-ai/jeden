//! The macOS half: build the sandbox profile from the declared read and
//! write roots, apply it to this process, and only then become the command,
//! so there is no window in which the child runs unconfined.
