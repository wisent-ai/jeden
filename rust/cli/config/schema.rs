...
static SETTINGS_SCHEMA: std::sync::LazyLock<Vec<SettingSpec>> = std::sync::LazyLock::new(|| {
    ...
    SettingSpec {
        ...
        typ: "string",
        description: "Context sources consulted on every run: any comma-separated subset of docs, ground-truth, memory, transcripts, or all. The archive scan and the ground-truth index are seconds slow, so they are not in the default pair.",
        default_json: "\"docs,memory\"",
        enum_values: &[],
    },
    SettingSpec {
        key: "context.advisor.roots",
        typ: "string",
        description: "Colon-separated documentation roots for the docs source, each optionally suffixed @depth. Empty means the project and ~/.jeden.",
        default_json: "\"\"",
        enum_values: &[],
    },
    SettingSpec {
        key: "context.advisor.docExtensions",
        typ: "string",
        description: "Comma-separated file extensions the docs source reads.",
        default_json: "\"md,mdx,markdown\"",
        enum_values: &[],
    },
    SettingSpec {
        key: "context.advisor.groundTruthUrl",
        typ: "string",
        description: "Base URL of the Wisent ground-truth API. Empty falls back to WISENT_GROUND_TRUTH_API or GROUND_TRUTH_API.",
        default_json: "\"\"",
        enum_values: &[],
    },
    SettingSpec {
