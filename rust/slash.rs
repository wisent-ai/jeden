...
pub fn handle_local(context: &SlashContext<'_>, input: &str) -> Option<Result<String, String>> {
    ...
    let result = match command.as_str() {
        ...
        "/browser" | "/extensions" | "/status" | "/marketplace" | "/plugins" | "/reload-plugins" | "/export" | "/dump" | "/share" | "/copy" | "/collab" | "/join" | "/leave" | "/btw" | "/tan" | "/omfg" | "/retry" | "/force" | "/force:" | "/handoff" => Some(handle_unavailable(command.as_str())),
        _ => None,
    };
    if changed {
