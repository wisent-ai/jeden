...
pub(in crate::agent) fn run_tool_action(args: &Args, recorder: &mut SessionRecorder, step: u32, action: &ToolAction, interactive: bool, allow_write: bool, allow_command: bool) -> Result<Value, String> {
