...
pub(super) fn readable_text_for_document(bytes: &[u8], path: &Path, content_type: Option<&str>) -> Result<String, String> {
...
pub(crate) fn fetch_readable_url(_runtime: &ToolRuntime<'_>, input: &Value) -> Result<Value, String> {
