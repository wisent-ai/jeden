 ...
 * and <a href="…">; this module parses them into elements when building.
 *
...
/* Static-site renderer. Kept with the documentation model it renders. */
...
function shell(page, body) {
  const { meta } = page;
  return `<!doctype html>
<!-- Generated by web/docs/pages.mjs from web/docs/pages.mjs — do not edit by hand. -->
<html lang="en">
  <head>
    <meta charset="utf-8" />
