    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Run <code>python3 tests/release/private-sources.py</code> with Rust and Python 3.12 to exercise the export, offline source selection with a service-style <code>PATH</code>, actual helper build and execution, and missing-toolchain, missing-input, lockfile-mismatch and missing-package refusals. Reports under <code>.wisent-output/release-tests/</code> retain the source revision, patch, command output, exit codes and helper hash. This check does not qualify a signed sandbox or a model-backed task.",
        ],
        commands: [
          {
