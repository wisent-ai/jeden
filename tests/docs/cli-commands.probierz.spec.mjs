...
export const EXPECTED_CLI_ROUTES = [
  ...
  ["/docs/cli/workspace/discover", "jeden workspace discover [path] [--json]"],
  ["/docs/cli/workspace/adopt", "jeden workspace adopt <path> [--json]"],
  ["/docs/cli/todo", 'jeden todo [list|add "request"|pause <id>|resume <id>|cancel <id>|defect <id>|answer <id> --text "answer"|continue] [--session <id-or-path>] [--revision <n> --reason "text"] [--json]'],
  ["/docs/cli/todo/list", "jeden todo list [--session <id-or-path>] [--json]"],
  ["/docs/cli/todo/add", 'jeden todo add "request" [--session <id-or-path>] [--json]'],
  ["/docs/cli/todo/pause", 'jeden todo pause <task-or-request-id> --revision <n> --reason "text" [--session <id-or-path>] [--json]'],
  ["/docs/cli/todo/resume", 'jeden todo resume <task-or-request-id> --revision <n> --reason "text" [--session <id-or-path>] [--json]'],
  ["/docs/cli/todo/cancel", 'jeden todo cancel <task-or-request-id> --revision <n> --reason "text" [--session <id-or-path>] [--json]'],
  ["/docs/cli/todo/defect", 'jeden todo defect <task-or-request-id> --revision <n> --reason "what failed" [--session <id-or-path>] [--json]'],
  ["/docs/cli/todo/answer", 'jeden todo answer <task-id> --revision <n> --text "answer" [--session <id-or-path>] [--json]'],
  ["/docs/cli/todo/continue", "jeden todo continue [--session <id-or-path>] [--allow-write] [--allow-command] [--model name] [--max-steps n] [--json]"],
